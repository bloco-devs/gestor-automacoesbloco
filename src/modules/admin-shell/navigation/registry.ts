...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  },
  {
    ...
    group: "plataforma",
    label: "Audit Center",
    description: "Trilha unificada de eventos com exportação CSV.",
    href: "/admin/audit",
    icon: FileWarning,
    status: "novo",
  },
  ...
  },
  {
    ...
    description: "Monitoramento do backup gerido pelo Supabase.",
    href: "/admin/backup",
    icon: FileWarning,
    status: "novo",
  },
  ...
  },
  {
    ...
    group: "seguranca",
    label: "Threat Center",
    description: "Eventos suspeitos, plugins rejeitados, capabilities negadas.",
